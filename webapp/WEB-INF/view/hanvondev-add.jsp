	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="20" class="input-text" value="" placeholder="" id="sn" name="sn">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>所属机构：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="institut_hao" class="select">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
<!-- 				<input type="Date picker" class="input-text" value="" placeholder="2000-01-01" id="class_id" name="birthday"> -->
				<input name="class_id" class="input-text" type="text"  />
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="30" class="input-text" value="" placeholder="" id="subnetmask" name="subnetmask">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>网关：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="gateip" name="gateip">
			</div>
		</div>
