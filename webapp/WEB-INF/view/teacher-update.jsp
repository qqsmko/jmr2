	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="${teacher.telephone}" id="telephone" name="telephone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮箱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" maxlength="30" class="input-text" value="" placeholder="${teacher.email}" id="email" name="email">
			</div>
		</div>
		<div class="row cl">
...
function article_save_submit(){
    ...
    $.ajax({
        ...
        url: "teacher-update/submit", //调用WebService的地址和方法名称组合 ---- WsURL/方法名
