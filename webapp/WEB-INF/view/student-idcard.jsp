...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-12 col-sm-6"><button onClick="getMockData();" type="button">读取身份证</button></span></label>
		</div>
...
function getMockData(){
	...
	document.getElementById("gender").value=json.sex;
	document.getElementById("nation").value=json.mile;
	var textValue =json.birthday; 
    var len = textValue.length;
    var year = textValue.substring(0,4);
    var month = textValue.substring(4,6);
    var day = textValue.substring(6,8);
    var str = year+'-'+month+'-'+day;
	//var ttDate =json.birthday;
