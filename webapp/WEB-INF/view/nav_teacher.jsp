				...
				<nav class="nav navbar-nav">
					<ul class="cl">
						...
						<% 
							...
							String ans = "null";
							if(str.equals("page1")){
								ans = "<li class=\"current\"><a href=\"?page=page1\">培训机构管理</a></li><li><a href=\"?page=page2\">系统维护</a></li>";
							}else if(str.equals("page2")){
								ans = "<li><a href=\"?page=page1\">培训机构管理</a></li><li class=\"current\"><a href=\"?page=page2\">系统维护</a></li>";
							}
						%>
						<%=ans%>
