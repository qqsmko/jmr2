...
<link rel="stylesheet" type="text/css" href="static/h-ui.admin/css/style.css" />
<link rel="stylesheet" type="text/css" href="lib/codebase/demo.css"/>
<!--[if IE 6]>
...
<title>新增摄像头</title>
<script>
		document.write("<link type='text/css' href='lib/codebase/demo.css?version=" + new Date().getTime() + "' rel='stylesheet' />");
	</script>
</head>
<body>
<div class="left">
...
<script src="lib/codebase/jquery-1.7.1.min.js"></script>
<script src="lib/codebase/webVideoCtrl.js"></script>
...
<script type="text/javascript">  
    ...
    var arr = new Array();  
    var count = 1;  
            <c:forEach items="${sl}" var="dec" varStatus="status">  
            arr[count] = new Array();  
            arr[count][1] = "${dec.ipAdr}";  
            arr[count][2] = "${dec.httpPort}";  
            arr[count][3] = "${dec.userName}";  
            arr[count][4] = "${dec.userPwd}";  
            arr[count][5] = "${dec.devScipt}";  
            arr[count][6] = "${dec.statV}"; 
            count++;
            </c:forEach>    			
</script> 
<script src="lib/codebase/webxiaoCtrl.js"></script>
<script type="text/javascript">
Login_vs();
</script>      
</html>