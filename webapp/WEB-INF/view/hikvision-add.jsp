...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>设备出厂编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="dev_hao" name="dev_hao">
			</div>
		</div>
		<div class="row cl">
...
<!-- 				<input type="Date picker" class="input-text" value="" placeholder="2000-01-01" id="class_hao" name="class_hao"> -->
				<input name="class_hao" class="input-text" type="text"  />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>设备IP：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="ip_adr" name="ip_adr">
			</div>
		</div>
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>服务端口：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="s_port" name="s_port">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>子俺码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="30" class="input-text" value="" placeholder="" id="sub_smask" name="sub_smask">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>网关：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="gate_ip" name="gate_ip">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>web端口：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="http_port" name="http_port">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="user_name" name="user_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>密   码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="user_pwd" name="user_pwd">
			</div>
		</div>
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>设备描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="50" class="input-text" value="" placeholder="" id="dev_scipt" name="dev_scipt">
			</div>
		</div>	
