	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" maxlength="20" class="input-text" value="${classes.className}" placeholder="" id="courseName" name="courseName" readonly="true">
			</div>
		<!-- </div>
		<div class="row cl"> -->
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">专业描述：</label>
		...
		<!-- </div>
		<div class="row cl"> -->
			<label class="form-label col-xs-4 col-sm-2">培训形式：</label>
			<div class="formControls col-xs-8 col-sm-3">
