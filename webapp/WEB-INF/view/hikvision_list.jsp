...
<html>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		 <a class="btn btn-primary radius" data-title="添加摄像头" data-href="hikvision-add.html" onclick="Hui_admin_tab(this)" href="javascript:;">
		 <i class="Hui-iconfont">&#xe600;</i> 添加摄像头</a></span></span> <!-- <span class="r">共有数据：<strong>88</strong> 条</span> --> </div>
		<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
			 <c:forEach items="${sl}" var="s" varStatus="st">
					<tr class="text-c">
						<td><input type="checkbox" value="${s.iinstutHao}" name="items"></td>
						<td>${s.devHao}</td>
						<td>
						<c:forEach items="${s2}" var="s2" varStatus="st2">
						<c:if test="${s.iinstutHao==s2.institutionsId}">
						${s2.institutionsName}
						</c:if>
						</c:forEach>
						</td>
						...
						<td>${s.userPwd}</td>
						<td>${s.devScipt}</td>
						<td class="td-manage"><a title="编辑" href="javascript:;" onclick="member_edit('编辑','hikvision_update.html?dev_hao=${s.devHao}','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a><a title="删除" href="javascript:;" onclick="member_del(this,${s.devHao})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
