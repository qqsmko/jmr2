	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="20" class="input-text" value="" placeholder="" id="className" name="className">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>预计人数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="studentCount" name="studentCount">
			</div>
		</div>
		<div class="row cl">
...
<!-- 				<input type="Date picker" class="input-text" value="" placeholder="2000-01-01" id="birthday" name="birthday"> -->
				<input name="startTime" class="input-text" type="text" onClick="WdatePicker()" />
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
<!-- 				<input type="Date picker" class="input-text" value="" placeholder="2000-01-01" id="birthday" name="birthday"> -->
				<input name="endTime" class="input-text" type="text" onClick="WdatePicker()" />
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" maxlength="20" class="input-text" value="" placeholder="" id="telephone" name="telephone">
			</div>
		</div>
		<div class="row cl">
...
function article_save_submit(){
    ...
    $.ajax({
        ...
        url: "class-add/submit", //调用WebService的地址和方法名称组合 ---- WsURL/方法名
