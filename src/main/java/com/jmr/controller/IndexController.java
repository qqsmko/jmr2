...
public class IndexController {
    ...
    public ModelAndView doIndexGET(@RequestParam(value="page", required=false) String page,@CookieValue(value = "username")String username,@CookieValue(value = "password")String password){
    	...
    	if(ans!=0){
    		if(page == null){
    			mav.setViewName("redirect:?page=page1");
    	        return mav;
    		}
    		if(ans==1){
